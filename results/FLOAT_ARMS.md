...
(its `build --target tensorrt --precision bf16 --config <family>/tensorrt/float` preset) and checked
with its drift suite against the bf16 PyTorch artifact (`validate --suite tensorrt-deploy`,
