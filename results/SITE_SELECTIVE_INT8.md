...
| checkpoint | eager | torch.compile | float TRT | W4A4 | W4A4 + o/d INT8 | INT8 cost |
|---|---:|---:|---:|---:|---:|---|
...
| π₀.₅, 10 steps | 168.6--170.8 | 100.5 | - | 77.3--78.6 | 82.3--84.4 | +4--6 ms, prefix LLM |

Engine bytes for the LLM: N1.7 442 -> 577 MB, π₀.₅ 948 -> 1269 MB (+34% in both); action-module
engines unchanged. The paper's latency figure carries the canonical controls (torch.compile / float TRT);
